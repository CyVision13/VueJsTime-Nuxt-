export const vueI18n = {"fallbackLocale":"fa","messages":{"fa":{"validation":{"min":"{_field_} باید حداقل  {length} کاراکتر باشد  ","required":"{_field_} الزامی است","email":"{_field_} نا معتبر است","even":"{_field_} فیلد باید زوج باشد"},"placeholder":{"default":"{0} را وارد نمایید...","selected":"{0} را انتخاب نمایید ..."},"logout":"خروج","number":"عدد","title":"عنوان"}}}
